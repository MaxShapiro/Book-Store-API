...
public abstract class MicroService implements Runnable {
    ...
    private ConcurrentHashMap<Class<? extends Message>,Callback > typeToCall;
    ...
    public MicroService(String name) {
        ...
        typeToCall = new ConcurrentHashMap<>();
    }

    //-------------Methods-------------
    /**
     * Subscribes to messages of type {@code type} with the callback
     * {@code callback}. This means two things:
     * 1. Subscribe to messages in the singleton event-bus using the supplied
     * {@code type}
     * 2. Store the {@code callback} so that when messages of type {@code type}
     ...
     * there may be messages which do not require any response and resolving.
     * <p>
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                if (m!=null && typeToCall.containsKey(m.getClass())) {
                    typeToCall.get(m.getClass()).call(m);
                }
